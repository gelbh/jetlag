...
use voronoi::{
    spatial_voronoi_from_sites_json as spatial_voronoi_native,
    spatial_voronoi_rings_from_coords as spatial_voronoi_rings_native,
};
...
/// WASM export: packed Voronoi rings for `coords = [lng0,lat0,…]` (no JSON).
