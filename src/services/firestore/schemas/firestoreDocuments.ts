...
export const sessionDocumentSchema = z
  .object({
    ...
    foundRequestedByUid: z.string().optional(),
    foundConfirmedAt: z.string().optional(),
    foundConfirmedByUid: z.string().optional(),
    gameOutcome: z.enum(["found", "ended_early", "abandoned"]).optional(),
    gameResultId: z.string().optional(),
