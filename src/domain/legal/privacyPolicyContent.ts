...
export const PRIVACY_POLICY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "If configured, the app sends anonymous product analytics to PostHog in the EU. Events cover page views and high-level actions such as creating a session or starting Premium checkout. Session codes, map content, Overpass payloads, and precise hide locations are not included. Analytics use in-memory storage in this version (no analytics cookies).",
    ],
  },
  {
    id: "third-parties",
