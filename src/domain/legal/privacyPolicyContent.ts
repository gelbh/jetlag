...
export const PRIVACY_POLICY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "The map loads tiles and data from third-party services such as OpenStreetMap (including Nominatim place search), OpenFreeMap street tiles, Esri satellite imagery and place labels, Overpass (and public Overpass mirrors), Open-Meteo and USGS elevation, and bundled transit feeds. Live vehicle data for some cities is fetched server-side via Transitland, TfL, or CTA APIs. Requests may include map coordinates or place names needed to render the map and answer game tools.",
