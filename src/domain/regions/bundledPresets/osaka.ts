...
const OSAKA_WARDS = [
  ...
  { id: "ward-27113", name: "Nishi-Yodogawa" },
  { id: "ward-27114", name: "Higashi-Yodogawa" },
  ...
  { id: "ward-27121", name: "Higashi-Sumiyoshi" },
...
export function osakaPresets(): BundledGamePresetDefinition[] {
  const baseHierarchy = [
    ...
    { id: "prefecture-osaka", category: "Prefecture", name: "Osaka Prefecture" },
    { id: "metro-osaka", category: "City", name: "Osaka City" },
  ] as const;
  const wardHierarchy = [
    ...baseHierarchy,
