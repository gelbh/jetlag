/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bf26a03cf962463e325abf4a8d4b59eb)
...
interface __BaseEnv_Env {
	...
	VITE_FIREBASE_APP_CHECK_DEBUG_TOKEN: string;
	...
	VITE_OVERPASS_PROXY_URL: string;
	VITE_SENTRY_DSN: string;
	VITE_SENTRY_ENVIRONMENT: string;
	VITE_TRANSITLAND_PROXY_URL: string;
	VITE_TRANSIT_PROXY_URL: string;
